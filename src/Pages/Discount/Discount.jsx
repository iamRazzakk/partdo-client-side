...
const Discount = () => {
    return (
        <div className="md:mt-40 bg-[url('https://i.ibb.co/ydPRs0B/pexels-mat-brown-952338.jpg')] bg-cover bg-center bg-no-repeat">
            <div className='py-28 text-white px-3 md:px-8 lg:px-32'>
                ...
                <Link to='/' className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-[#f4f0f0] rounded-md shadow-md group">
                    <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-[#49f73a] group-hover:translate-x-0 ease">
