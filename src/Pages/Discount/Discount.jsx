            ...
            <div className="hero min-h-[450px] mt-12 w-full relative">
                <div className="carousel-container">
                    <Carousel showThumbs={false} infiniteLoop autoPlay>
                        <div>
                            <img className='h-[450px] w-full' src="../3 car.jpeg" alt="Discount Banner 1" />
                        </div>
                        <div>
                            <img className='h-[450px] w-full' src="../4 car.jpeg" alt="Discount Banner 2" />
                        </div>
                        <div>
                            <img className='h-[450px] w-full' src="../5 car .jpeg" alt="Discount Banner 3" />
                        </div>
                    </Carousel>
                </div>
