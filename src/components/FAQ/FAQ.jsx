...
const FAQ = () => {
    ...
    return (
        <div>
            <div className="md:flex md:mt-40 p-4 sm:mt-32">
                <div data-aos="fade-left" className="flex-1 md:p-[80px] space-y-6">
                    <h3 className="text-2xl md:text-3xl  lg:text-5xl font-bold mb-2">FREQUENTLY ASKED QUESTIONS</h3>
                    <h1 className="text-2xl md:text-3xl  lg:text-5xl font-bold mb-2">Here Our Most Question</h1>
