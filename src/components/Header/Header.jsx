    ...
    return (
        <div>
            <div className='h-[100vh] relative w-full'>
                <video autoPlay muted loop className='h-[100vh] object-cover w-full mx-auto form-control' src={carVideo}>
                </video>
                <div className='w-1/3 font-salsa -mt-[450px] ml-10'>
                    ...
                    <Link to='car' className=" relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-black border border-black rounded-lg shadow-inner group">
